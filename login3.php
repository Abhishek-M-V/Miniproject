...
<body>
  ...
  <div class="container">
    <h2><u>BusOwnerLogin</u></h2>
    <form action="busownerdb.php" method="POST">
      <label for="username"><b>VehicleNumber:</b></label>
      ...
      <div class="show-password">
        ...
        <label for="showPassword"><font color="white">Show Password</font></label>
      </div> 
     <div class="login">
      ...
      <input type="button"  value="New to the page?Signup!" onclick="location.href='signup2.php';">
    </div>
    </form>
  </div>
</body>
