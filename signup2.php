...
<div class="container">
  <h2>OWNER'S SIGNUP</h2>
  <form action="busownerreg.php" method="POST" >
...
<div class="form-group"><label for="vnumber">Vehicle Number:</label>
    <input type="text" id="vnumber" name="vnumber" required><br><br>
</div>
    
<div class="form-group">
    <label for="lnumber">License Number:</label>
    <input type="text" id="lnumber" name="lnumber" required><br><br>
</div>


<div class="form-group">
    <label for="document">Upload License:</label>
